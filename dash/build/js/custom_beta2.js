...
function init_charts() {
        ...
        var lineChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    pointHoverBorderColor: "rgba(220,220,220,1)",
                    pointBorderWidth: 1,
                    data: [173, 150, 193, 180, 201, 169, 156]
                }]
            },
        });
    }
    ...
    if ($('#canvasRadar').length) {
        ...
        var data = {
            labels: ["Speed", "Tackle Sucecess", "Strength", "Stamina", "Accuarcy", "Throwing", "Catching"],
            datasets: [{
                label: "Average stats",
...
function init_calendar() {
    ...
    var calendar = $('#calendar').fullCalendar({
        ...
        events: [{
            ...
            title: 'Training Session NOC',
            start: new Date(y, m, d, 10, 30),
            allDay: false
        }, {
            title: 'Training session SD',
            start: new Date(y, m, d + 14, 12, 0),
            end: new Date(y, m, d, 14, 0),
            allDay: false
        }, {
            title: 'Training Session IH',
            start: new Date(y, m, d + 1, 19, 0),
            end: new Date(y, m, d + 1, 22, 30),
            allDay: false
        }, {
            title: 'Training Session PM',
...
function init_echarts() {
    ...
    function analysis(file_name) {
        ...
        if (!file_name) {
            var file_name = "Alex.csv";
        };

        //var url = "../../Data/"+file_name;
        var url = "../../Data/Novices/" + file_name;
        ...
        var dm = Papa.parse(url, {
            ...
            complete: function(db) {
                ...
                tackle_data_a = [
                    ...
                    { value: (1 - Tackle_succ_r_percentage) * 100, name: "Unsuccessful Right", selected: true }, //took out +1
                ...
                for (i in db) {
                    ...
                    for (j = 0; j < 5; j++) {
                        ...
                        fatigue_data.push([lable, db[i][7 + j]]);
                ...
                for (i in db) {
                    ...
                    // var itd = (itt[1].slice(0,4));
                    // var lable =  itd +"-"+ side+"-T"+(j+1);
                    if (db[i][2] == 'L') dist_cov_l.push([side, db[i][8]]);
                    if (db[i][2] == 'R') dist_cov_r.push([side, db[i][8]]);
                ...
                console.log("dec time ---->", decision_t, "eff ----->", movement_eff_d, "tackle--->", Tackle_succ_percentage, 'tackle lengh', tackle_succ.length)
                    //Right here
                solar_data = [decision_t, Tackle_succ_percentage * 10, movement_eff_d];
                ...
                function averageSpeed() {
                    ...
                    speed_avg = (speed_avg / speed_tmp.length).toFixed(0);
                    return speed_avg;
                }
